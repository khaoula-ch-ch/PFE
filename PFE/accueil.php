    ...
    <div class="naVbar"><br>
        <naV>
            <ul>
              ...
              <li> 
			     <a href="index.php" >
		             <img src="1.png" width="52" height="42" class="rounded-circle" >
		         </a>
              </li>
              <li> 
                 <a href="profil.php" >
        ...
        <div class="row">
        <div class="col">
        <h1>Gestion des courriers <center><img src="logo.png" width="200" height="100"></center></h1></div>
        <div class="col">
            <div class="card card1">
              <h3> <a href="new.php" >Nouveau courrier</a></h3>
              
            </div>
            <div class="card card2">
                <h3><a href="  ">courrier entrant</a></h3>
            
              </div>
              <br>
              <div class="card card3">
                <h3><a href="">courrier sortant</a></h3>
              </div>
              <div class="card card4">
                <h3><a href="">corbeille</a> </h3>
              </div>
        </div>
        </div>
    </div>
