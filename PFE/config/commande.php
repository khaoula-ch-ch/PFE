<?php
 ...
 function ajouter($ref,$naturecour,$confidentiel,$datecourr,$envoyerpar,$distination,$sousdistination,$datetraite,$remarque,$objet,$naturedoc,$fichier)
  {   if(require("connexion.php")){
      $req = $access->prepare("INSERT INTO courrierarrive(ref,naturecour,confidentiel,datecourr,envoyerpar,distination,sousdistination,datetraite,remarque,objet,naturedoc,fichier) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");

      $req->execute(array($ref,$naturecour,$confidentiel,$datecourr,$envoyerpar,$distination,$sousdistination,$datetraite,$remarque,$objet,$naturedoc,$fichier));
