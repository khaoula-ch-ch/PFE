    ...
    <div class="formulaire">
        ...
        <form method="post">
            ...
            <div class="form1">
                ...
                <input type="text" name="ref" class="input"><br><br>
                ...
                <select id="pays" class="input"  name="naturedoc">
            ...
            <div class="form2">
                ...
                <select name="naturecour"  class="input">
                    <option value="urgent">Urgent</option>
                    <option value="normal">Normal</option>
                    <option value="tres urgent ">Tres urgent </option>
                </select><br><br>
                <label> Confidentiel :</label>
       <select name="confidentiel"  class="input">
        <option value="oui">oui</option>
        <option value="non">non</option>
       </select>
                <label>Remarque :</label>
                <textarea cols="10" rows="5" class="input" name="remarque"></textarea><br><br>
